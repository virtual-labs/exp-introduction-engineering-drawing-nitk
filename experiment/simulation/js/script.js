...
function re() {
  ...
  document.getElementById("text").innerHTML =
    "Draw a Line equal to diameter of Polygon";
...
function roti() {
  ...
  if (i == 0) {
    ...
    ctx.arc(
      ...
      214,
      100,
      1.5 * Math.PI + Math.PI / 7,
      1.5 * Math.PI + Math.PI / 5
    );
    ctx.stroke();
    ctx.closePath();
    ctx.beginPath();
    ...
    animate(
      201,
      214,
      301 - 100 * Math.cos(Math.PI / 3),
      214 - 100 * Math.sin(Math.PI / 3)
    );
    animate(
      401,
      214,
    ...
    animate(
      301 + 100,
      214,
      301 + 100 * Math.sin(Math.PI / 6),
      214 + 100 * Math.cos(Math.PI / 6)
    );
    animate(
      301 + 100 * Math.sin(Math.PI / 6),
      214 + 100 * Math.cos(Math.PI / 6),
      201 + 100 * Math.sin(Math.PI / 6),
      214 + 100 * Math.cos(Math.PI / 6)
    );
    animate(
      201 + 100 * Math.sin(Math.PI / 6),
...
function roti1() {
  if (p == 0) {
    ...
    stepNumber.textContent = "5";
    stepTitle.innerHTML =
      "Using <b>OB</b> as the radius, draw an arc from <b>B</b> that intersects the extention of <b>OF</b>";
  } else if (p == 4) {
    ctx.beginPath();
    ...
    stepNumber.textContent = "6";
    stepTitle.innerHTML =
      "Using <b>OB</b> as radius, draw an arc from <b>D</b> that intersects the extention of <b>OE</b>";
  } else {
    ctx.strokeStyle = "#000080";
    ctx.lineWidth = 2;
    stepNumber.textContent = "7";
    ...
    animate(
      299,
      144,
      269 - 100 * Math.cos(Math.PI / 3),
      291 - 100 * Math.sin(Math.PI / 3)
    );
    animate(
      299,
      144,
      329 + 100 * Math.cos(Math.PI / 3),
      291 - 100 * Math.sin(Math.PI / 3)
    );
...
function rotateimagea() {
  ...
  if (j == 0) {
    ...
    setTimeout(function () {
      ...
      ctx.fillText("∠DAB is the bisection of ∠BAC", 70, 370);
    }, 900);
  } else {
    j = 0;
  }
  ...
  displayDiv({
    classList: {
      contains: function (className) {
        return className === "tool-practice";
      },
    },
  });
  radioButtons.forEach((radio) => {
